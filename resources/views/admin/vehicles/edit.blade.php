                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group {{ $errors->has('seller_company') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control select2" name="seller_company_id" id="seller_company_id">
                                                ...
                                                <option value="{{ $id }}" {{ (old('seller_company_id') ? old('seller_company_id') : $vehicle->seller_company->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group {{ $errors->has('buyer_company') ? 'has-error' : '' }}">
                                            ...
                                            <select class="form-control select2" name="buyer_company_id" id="buyer_company_id">
                                                ...
                                                <option value="{{ $id }}" {{ (old('buyer_company_id') ? old('buyer_company_id') : $vehicle->buyer_company->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                                @endforeach
                                            </select>
