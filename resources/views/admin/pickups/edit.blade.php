        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.pickup.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.pickups.update", [$pickup->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('vehicle') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="vehicle_id" id="vehicle_id" required>
                                @foreach($vehicles as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('vehicle_id') ? old('vehicle_id') : $pickup->vehicle->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('suplier') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="suplier_id" id="suplier_id" required>
                                @foreach($supliers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('suplier_id') ? old('suplier_id') : $pickup->suplier->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('carrier') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="carrier_id" id="carrier_id" required>
                                @foreach($carriers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('carrier_id') ? old('carrier_id') : $pickup->carrier->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('storage_location') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="storage_location" id="storage_location" value="{{ old('storage_location', $pickup->storage_location) }}">
                        ...
                        <div class="form-group {{ $errors->has('withdrawal_authorization') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="withdrawal_authorization" id="withdrawal_authorization" value="{{ old('withdrawal_authorization', $pickup->withdrawal_authorization) }}">
                        ...
                        <div class="form-group {{ $errors->has('withdrawal_authorization_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="withdrawal_authorization_date" id="withdrawal_authorization_date" value="{{ old('withdrawal_authorization_date', $pickup->withdrawal_authorization_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('pickup_state') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="pickup_state_id" id="pickup_state_id">
                                @foreach($pickup_states as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('pickup_state_id') ? old('pickup_state_id') : $pickup->pickup_state->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('pickup_state_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="pickup_state_date" id="pickup_state_date" value="{{ old('pickup_state_date', $pickup->pickup_state_date) }}">
